...
void display (CERElement element, ubyte indentation)
{
    ...
    else
    {
        ...
        while (i < value.length)
            subs ~= new CERElement(i, value);

        foreach (sub; subs)
        {
            display(new CERElement(element.value), indentation); 
        }
    }
    indentation -= 4;
}

string stringifyUniversalValue (CERElement element)
{
