/**
    ...
    $(UL
        $(LI Basic Aligned Packed Encoding Rules)
        $(LI Basic Unaligned Packed Encoding Rules)
        $(LI Canonical Aligned Packed Encoding Rules)
        $(LI Canonical Unaligned Packed Encoding Rules)
    )
    ...
    Packed Encoding Rules (PER) is a specification created by the
    $(LINK https://www.itu.int/en/pages/default.aspx, International Telecommunications Union),
    and specified in
    $(LINK https://www.itu.int/rec/T-REC-X.691-201508-I/en, X.690 - ASN.1 encoding rules: Specification of Packed Encoding Rules (PER))
...
///
public alias PERElement = BasicAlignedPackedEncodingRulesElement;
///
public alias BAPERElement = BasicAlignedPackedEncodingRulesElement;
///
public alias BAPackedEncodingRulesElement = BasicAlignedPackedEncodingRulesElement;
///
public alias BasicAlignedPERElement = BasicAlignedPackedEncodingRulesElement;
///
public alias PackedEncodingRulesElement = BasicAlignedPackedEncodingRulesElement;
/**
...
*/
public
class BasicAlignedPackedEncodingRulesElement : ASN1Element!BAPERElement, Byteable
{
    @system
    unittest
    {
    ...
    private BitArray _preambleBits = BitArray();
    private BitArray _lengthBits = BitArray();
    private BitArray _valueBits = BitArray();

    public Nullable!ptrdiff_t minimum;
    public Nullable!ptrdiff_t maximum;

    public @property @safe @nogc pure
    size_t range() const
    {
        if (this.minimum.isNull) return size_t.max;
        if (this.maximum.isNull) return size_t.max;
        if (this.maximum < this.minimum)
            throw new ASN1ValueException("Max cannot be less than minimum.");
        return cast(size_t) (this.maximum - this.minimum + 1u); // REVIEW
    }

    public @property @safe @nogc pure
    size_t bitsNeededToEncodeNumber() const
    {
        return cast(size_t) ceil(log2(this.range));
    }

    /// Whether this value is limited by both lower and upper bounds.
    public @property @safe @nogc nothrow pure
    bool constrained() const
    {
        return (!this.minimum.isNull && !this.maximum.isNull);
    }
    ...
    /// Whether this value is neither limited by lower nor upper bounds.
    public @property @safe @nogc nothrow pure
    bool unconstrained() const
    {
        return this.minimum.isNull;
    }
    ...
    */
    ...
    {
        throw new Exception("EOC Not implemented for PER!");
    }
    ...
    */
    ...
    out
    {
        assert(this._bitStream.length > 0u);
    }
    do
    {
        this._valueBits.length = 1u;
        this._valueBits[0] = value;
    }
    ...
    */
    ...
    do
    {
        if (this.constrained)
        {
            if (value < this.minimum.get())
                throw new ASN1ValueException("Supplied INTEGER was below the permitted minimum.");

            if (value > this.minimum.get())
                throw new ASN1ValueException("Supplied INTEGER was below the permitted minimum.");

            this._valueBits = BitArray([]);
            size_t range = this.range;
            if (range == 1u) return;
            immutable ubyte difference = cast(ubyte) (value - this.minimum); // REVIEW
            if (range >= 2u && range <= 255u)
            {
                for (size_t i = (8u - this.bitsNeededToEncodeNumber); i < this.bitsNeededToEncodeNumber; i++)
                {
                    this._valueBits ~= (difference & (0b00000001u << i));
                }
            }
            else if (range == 256u)
            {
                this._valueBits ~= [
                    cast(bool) (difference & 0b10000000u),
                    cast(bool) (difference & 0b01000000u),
                    cast(bool) (difference & 0b00100000u),
                    cast(bool) (difference & 0b00010000u),
                    cast(bool) (difference & 0b00001000u),
                    cast(bool) (difference & 0b00000100u),
                    cast(bool) (difference & 0b00000010u),
                    cast(bool) (difference & 0b00000001u)
                ];
            }
            else if (range >= 257u && range <= 65537u)
            {
                this._valueBits ~= [
                    cast(bool) (difference & 0b10000000_00000000u),
                    cast(bool) (difference & 0b01000000_00000000u),
                    cast(bool) (difference & 0b00100000_00000000u),
                    cast(bool) (difference & 0b00010000_00000000u),
                    cast(bool) (difference & 0b00001000_00000000u),
                    cast(bool) (difference & 0b00000100_00000000u),
                    cast(bool) (difference & 0b00000010_00000000u),
                    cast(bool) (difference & 0b00000001_00000000u),
                    cast(bool) (difference & 0b00000000_10000000u),
                    cast(bool) (difference & 0b00000000_01000000u),
                    cast(bool) (difference & 0b00000000_00100000u),
                    cast(bool) (difference & 0b00000000_00010000u),
                    cast(bool) (difference & 0b00000000_00001000u),
                    cast(bool) (difference & 0b00000000_00000100u),
                    cast(bool) (difference & 0b00000000_00000010u),
                    cast(bool) (difference & 0b00000000_00000001u)
                ];
            }
            else
            {
                immutable size_t bytesNeededToEncodeNumber = (this.bitsNeededToEncodeNumber >> 3u);
        ...
        else if (this.semiConstrained)
        {

        }
        else // should be unconstrained
        {
    ...
    unittest
    {
        BAPERElement el = new BAPERElement();
    ...
    */
    ...
    bool[] bitString() const
    {
        ...
        else
        {
            ...
            BAPERElement[] substrings = this.sequence;
    ...
    unittest
    {
        ...
        BAPERElement element = new BAPERElement(data);
    ...
    */
    ...
    unittest
    {
        if (this.nestingRecursionLimit < 128u) // This test will break above this number.
        {
            ...
            BAPERElement element = new BAPERElement();
    ...
    */
    ...
    unittest
    {
        ...
        {
            size_t sentinel = 0u;
            BAPERElement element = new BAPERElement(sentinel, data);
    ...
    */
    ...
    External external() const
    {
        ...
        const BAPERElement[] components = this.sequence;
    ...
    */
    ...
    do
    {
        ...
        BAPERElement[] components = [];

        if (!(value.identification.syntax.isNull))
        {
            BAPERElement directReference = new BAPERElement();
        ...
        else if (!(value.identification.contextNegotiation.isNull))
        {
            ...
            BAPERElement indirectReference = new BAPERElement();
        ...
        BAPERElement dataValueDescriptor = new BAPERElement();
        ...
        BAPERElement dataValue = new BAPERElement();
    ...
    unittest
    {
        ...
        for (ubyte i = 0x07u; i < 0x1Eu; i++)
        {
            external[2] = i;
            size_t x = 0u;
            BAPERElement el = new BAPERElement(x, external);
    ...
    unittest
    {
        ...
        assertThrown!ASN1Exception((new BAPERElement(external)).external);
    ...
    */
    ...
    EmbeddedPDV embeddedPresentationDataValue() const
    {
        ...
        */
        ...
        const BAPERElement identificationChoice = new BAPERElement(bytes);
        switch (identificationChoice.tagNumber)
        {
            case (0u): // syntaxes
            {
                ...
                const BAPERElement[] syntaxesComponents = identificationChoice.sequence;
            ...
            case (3u): // context-negotiation
            {
                ...
                const BAPERElement[] contextNegotiationComponents = identificationChoice.sequence;
    ...
    */
    ...
    {
        scope(success) this.construction = ASN1Construction.constructed;
        BAPERElement identification = new BAPERElement();
        ...
        if (!(value.identification.syntaxes.isNull))
        {
            ...
            BAPERElement transferSyntax = new BAPERElement();
        ...
        {
            BAPERElement presentationContextID = new BAPERElement();
    ...
    unittest
    {
        ...
        for (ubyte i = 0x81u; i < 0x9Eu; i++)
        {
            data[2] = i;
            size_t x = 0u;
            BAPERElement el = new BAPERElement(x, data);
    ...
    */
    ...
    BAPERElement[] sequence() const
    {
        ...
        size_t i = 0u;
        Appender!(BAPERElement[]) result = appender!(BAPERElement[])();
        while (i < this.value.length)
            result.put(new BAPERElement(i, this.value));
        return result.data;
    }

    /// Encodes a sequence of elements
    override public @property @system
    void sequence(in BAPERElement[] value)
    {
        scope(success) this.construction = ASN1Construction.constructed;
    ...
    */
    ...
    override public @property @system
    void set(in BAPERElement[] value)
    {
        scope(success) this.construction = ASN1Construction.constructed;
        Appender!(ubyte[]) result = appender!(ubyte[])();
        foreach (element; value)
    ...
    */
    ...
    do
    {
        ...
        BAPERElement stringValue = new BAPERElement();
    ...
    */
    ...
    /**
        Creates a $(D BAPERElement) from the supplied bytes, inferring that the first
        byte is the type tag. The supplied $(D ubyte[]) array is "chomped" by
        reference, so the original array will grow shorter as $(D BAPERElement)s are
        generated.
    ...
    */
    ...
    /**
        ...
        expects the encoded bytes to encode only one $(BAPERElement). If there are
    ...
    size_t fromBytes (in ubyte[] bytes)
    {
        ...
        if ((bytes[cursor] & 0x80u) == 0x80u)
        {
            ...
            else // Indefinite
            {
                ...
                {
                    BAPERElement child = new BAPERElement(sentinel, bytes);
                    if
                    (
...
unittest
{
    ...
    size_t i = 0u;
    while (i < data.length)
        result ~= new BAPERElement(i, data);
...
unittest
{
    ...
    BAPERElement[] results;
    size_t i = 0u;
    while (i < data.length) results ~= new BAPERElement(i, data);
    ...
    results = [];
    while (data.length > 0) results ~= new BAPERElement(data);
    assert(results.length == 3);
    foreach (result; results)
    {
        assert(result.length == 216u);
    ...
    ubyte[] data = [
        0x2Cu, 0x80u,
            0x2Cu, 0x80u,
                ...
                0x00u, 0x00u,
            0x00u, 0x00u ];
    assertNotThrown!ASN1Exception(new BAPERElement(data));
}
...
{
    ubyte[] invalid = [];
    for (size_t i = 0u; i < BAPERElement.nestingRecursionLimit+1; i++)
    {
        invalid ~= [ 0x2Cu, 0x80u ];
    }
    assertThrown!ASN1RecursionException(new BAPERElement(invalid));
}
...
unittest
{
    ...
    assertThrown!ASN1Exception(new BAPERElement(invalid));
...
unittest
{
    ...
    assert((new BAPERElement(data)).value == [ 0x04u, 0x04u, 0x00u, 0x00u, 0x00u, 0x00u ]);
}
...
unittest
{
    ...
    BAPERElement el;
    assertNotThrown!Exception(el = new BAPERElement(test));
...
unittest
{
    ...
    {
        ubyte[] data = [i];
        assertThrown!ASN1TruncationException(new BAPERElement(data));
    }
    ...
    for (ubyte i = 0x00u; i < ubyte.max; i++)
    {
        ...
        assertThrown!ASN1TruncationException(new BAPERElement(index, data));
    }
}
...
unittest
{
    ...
    assertThrown!ASN1TagException(new BAPERElement(invalid));
...
unittest
{
    ...
    assertThrown!ASN1TruncationException(new BAPERElement(test));
}
...
unittest
{
    ...
    assertThrown!ASN1TruncationException(new BAPERElement(invalid));
}
...
unittest
{
    ...
    assertThrown!ASN1TruncationException(new BAPERElement(big));
}
...
unittest
{
    ...
    big ~= [ 0x01u, 0x02u, 0x03u ]; // Plus some arbitrary data.
    assertThrown!ASN1LengthException(new BAPERElement(big));
}
...
unittest
{
    ...
    size_t bytesRead = 0u;
    assertThrown!ASN1TruncationException(new BAPERElement(bytesRead, naughty));
}
...
unittest
{
    ...
    size_t bytesRead = 0u;
    assertNotThrown!ASN1TruncationException(new BAPERElement(bytesRead, naughty));
}
...
unittest
{
    BAPERElement e = new BAPERElement();
    e.boolean = false;
