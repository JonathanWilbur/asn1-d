// D import file generated from '.\source\asn1\codecs\der.d'
...
public class DistinguishedEncodingRulesElement : ASN1Element!DERElement, Byteable
{
	...
	public override const @property @safe ubyte[] octetString();
			...
			{
				{
					...
					return (this.value[0] & 64u ? -1.00000 : 1.00000) * cast(T)mantissa * cast(T)base ^^ cast(T)exponent;
				}
			}
			default:
			{
	...
	public @property @system void realNumber(T)(in T value) if (isFloatingPoint!T)
	{
		scope(success) this.construction = ASN1Construction.primitive;
	...
	public override const @property @system DERElement[] sequence();
	public override @property @system void sequence(in DERElement[] value);
	public override const @property @system DERElement[] set();
	public override @property @system void set(in DERElement[] value);
	...
	public override const @property @safe ubyte[] teletexString();
	public override nothrow @property @safe void teletexString(in ubyte[] value);
	public override const @property @safe ubyte[] videotexString();
